        ...
        <div>
	      <Grid container spacing={0}>
	      	<form className={classes.container} noValidate autoComplete="off">
		        <Grid item xs={12}>
				    <TextField margin="normal" type="email" onChange={this.handleChange('email')} className={classes.textField} inputRef={(email) => this.email = email} placeholder={this.props.contact.email[this.props.lang]} />
				  </Grid>

				<Grid item xs={12}>
				    <TextField margin="normal" type="password" onChange={this.handleChange('password')} className={classes.textField} inputRef={(pw) => this.pw = pw} placeholder={this.props.contact.password[this.props.lang]} />
				 </Grid>
				...
				<Grid item xs={6}>
				    <Button className={classes.button} type="submit" value="signin" onClick={this.handleSubmitLogin}>
